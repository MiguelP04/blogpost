      ...
      <div className="flex min-h-screen bg-gray-100">
        <nav className="w-48 bg-white shadow flex flex-col">
          ...
          <button
            ...
            className={`p-4 text-left hover:bg-indigo-100 transition ${
              selectedSection === "profile" ? "bg-indigo-200 font-bold" : ""
            }`}
          >
            Perfil
          </button>
          <button
            ...
            className={`p-4 text-left hover:bg-indigo-100 transition ${
              selectedSection === "posts" ? "bg-indigo-200 font-bold" : ""
            }`}
          >
            Posts
          </button>
          <button
            ...
            className={`p-4 text-left hover:bg-indigo-100 transition ${
              selectedSection === "albums" ? "bg-indigo-200 font-bold" : ""
            }`}
          >
            Álbumes
          </button>
